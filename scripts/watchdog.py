...
parser.add_argument('--motion-blob-stride', type=int, default=2, help='Side length of a square blob in pixels.')
parser.add_argument('--motion-blob-threshold', type=int, default=10, help='How many blobs should be in motion to start paying attention.')
